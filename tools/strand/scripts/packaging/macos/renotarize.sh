#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/strand/archive/renotarize.sh
# Spec: tools/strand/specs/renotarize.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/strand/specs/renotarize.json"
