...
Archived body: tools/condense/archive/glm52_pilot_source_release.py
...
_ARCHIVE_PATH = _PathForShim(__shim_file__).parent / "archive" / "glm52_pilot_source_release.py"
