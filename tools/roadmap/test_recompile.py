...
# REMOVED 2026-09-05 by operator instruction: the roadmap is updated too often
# for a pinned hash to mean anything. "there isn't one true roadmap except for the
# one I point you to." Verification of a superseded lineage copy was checking the
# identity of a document nobody reads any more; the live roadmap is authority and
# it is deliberately unpinned.
