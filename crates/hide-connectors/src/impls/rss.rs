...
//!
//! Read-only. Does **not** implement [`crate::connector::ConnectorWrite`].

use std::fs;
use std::path::PathBuf;

use crate::abi::{ConnectorAbi, FamilyId};
use crate::account::{AccountHandle, AccountStore, InFlightGuard};
use crate::connector::{
