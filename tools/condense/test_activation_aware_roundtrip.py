...
Archived body: tools/condense/archive/test_activation_aware_roundtrip.py
...
_ARCHIVE_PATH = _PathForShim(__shim_file__).parent / "archive" / "test_activation_aware_roundtrip.py"
