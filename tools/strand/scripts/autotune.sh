#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/strand/archive/autotune.sh
# Spec: tools/strand/specs/autotune.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/strand/specs/autotune.json"
