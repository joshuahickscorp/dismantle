...
use crate::tooling::spec_helpers::write_spec;
...
use crate::tooling::common;
use crate::tooling::spec_helpers::{read_spec, write_spec};
use futures::future::BoxFuture;
...
use crate::tooling::common;
use crate::tooling::spec_helpers::{git_read_spec, git_write_spec};
use futures::future::BoxFuture;
use hide_core::persistence::BlobStore;
use hide_core::tool::{Purity, Tool, ToolCtx, ToolResult, ToolSpec};
use hide_core::types::{Effect, EffectKind, EffectSet, RiskLevel};
...
use crate::tooling::shell::{run_command, ShellConfig};
use crate::tooling::spec_helpers::exec_spec;
use futures::future::BoxFuture;
use hide_core::tool::{Purity, Tool, ToolCtx, ToolResult, ToolSpec};
use hide_core::types::{Effect, EffectKind, EffectSet, RiskLevel};
...
// --- inlined tooling/registry.rs ---
pub mod registry {
//! Registration of the builtin catalog into a `hide-core` `ToolRegistry`.

use crate::tooling::edit::{ApplyPatchTool, SearchReplaceTool, WriteFileTool};
use crate::tooling::fs::{
    FsConfig, FsGlobTool, FsListTool, FsReadTool, FsStatTool, FsWatchTool, FsWriteTool,
};
use crate::tooling::git::{
    GitCommitTool, GitConfig, GitDiffTool, GitLogTool, GitStatusTool, GitWorktreeAddTool,
    GitWorktreeListTool, GitWorktreeRemoveTool,
};
use crate::tooling::memory::MemoryTool;
use crate::tooling::proc::ProcTool;
use crate::tooling::search::SearchTextTool;
use crate::tooling::shell::{ShellConfig, ShellPlanTool, ShellRunTool};
...
use crate::tooling::common;
use crate::tooling::spec_helpers::read_spec;
use futures::future::BoxFuture;
use hide_core::tool::{Purity, Tool, ToolCtx, ToolResult, ToolSpec};
use hide_core::types::EffectSet;
...
//!   SBPL profile rendered by `crate::security::sandbox::render_macos_seatbelt_with`
...
/// shells out to. `crate::security::sandbox::render_macos_seatbelt` turns this into
...
mod tests {
    ...
    async fn shell_run_executes_and_captures_stdout() {
        // Unit path: sandbox-exec is environment-sensitive under nested agents;
        // confinement is covered by sandbox profile tests. EXEC behaviour here.
        let registry = Arc::new(ToolRegistry::default());
        registry.register(ShellRunTool::with_config(ShellConfig {
            disable_sandbox: true,
            ..Default::default()
        }));
...
// --- inlined tooling/spec_helpers.rs ---
