#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/bench/archive/llama_bench.sh
# Spec: tools/bench/specs/llama_bench.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/bench/specs/llama_bench.json"
