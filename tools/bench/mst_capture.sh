#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/bench/archive/mst_capture.sh
# Spec: tools/bench/specs/mst_capture.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/bench/specs/mst_capture.json"
