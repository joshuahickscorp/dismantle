#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/bench/archive/ratios.sh
# Spec: tools/bench/specs/ratios.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/bench/specs/ratios.json"
