#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/bench/archive/quick_bench.sh
# Spec: tools/bench/specs/quick_bench.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/bench/specs/quick_bench.json"
