...
def curated_mechanisms() -> list[dict[str, Any]]:
    return [
        ...
        mech(
            ...
            source_path="workspace/superwave/g1/claude-evidence/g1_share_basis.py",
            experiment_id="G1-SHARE",
            artifact="workspace/superwave/g1/claude-evidence/g1_share_basis.json",
            status="RAN",
            measured_result={
            ...
            reusable_now=False,
            recovered_from="code cites deleted worktree ~/.claude-grok/worktrees/204-share-basis-20260817-181022; script+receipt survived in workspace/superwave/g1/",
            accounting_excluded=[
        ...
        mech(
            ...
            source_path="workspace/superwave/g1/claude-evidence/g1_tensor_operators.py",
            experiment_id="G1-TENSOR / G034",
            artifact="workspace/superwave/g1/claude-evidence/g1_tensor_operators.json",
            status="REFUTED",
            measured_result={
                "selfcheck": "PASS",
        ...
        mech(
            ...
            source_path="lab/operators/frankenstein_fusion_op.py",
...
def tensor_operator_ebpw_rows() -> list[dict[str, Any]]:
    doc = load_json("workspace/superwave/g1/claude-evidence/g1_tensor_operators.json")
...
def other_sub05_components() -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "source_path": "workspace/superwave/g1/claude-evidence/g1_share_basis.json",
            "experiment_id": "G1-SHARE",
...
def seed_verification() -> dict[str, Any]:
    ...
    confirmed = {
        ...
        "g1_share_basis_py_exists": exists_rel("workspace/superwave/g1/claude-evidence/g1_share_basis.py"),
...
def worktree_recoveries(worktrees: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    for rel, why in (
        ...
        (
            "workspace/superwave/g1/claude-evidence/g1_tensor_operators.json",
...
def build_index(install_info: dict[str, Any], index_path: Path, index_kind: str) -> dict[str, Any]:
    ...
    g1doc = load_json("workspace/superwave/g1/claude-evidence/g1_tensor_operators.json") or {}
    g1_family_rows = 0
    g1_healthy_true = 0
