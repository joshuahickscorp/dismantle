#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/strand/archive/make-app.sh
# Spec: tools/strand/specs/make_app.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/strand/specs/make_app.json"
