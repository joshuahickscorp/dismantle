#!/usr/bin/env python3
"""lab_harness archive shim — body at tools/training/archive/rwkv7_capture_teacher_logits.py."""
...
_TARGET = _repo() / 'tools/training/archive/rwkv7_capture_teacher_logits.py'
