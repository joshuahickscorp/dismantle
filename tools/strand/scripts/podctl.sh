#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/strand/archive/podctl.sh
# Spec: tools/strand/specs/podctl.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/strand/specs/podctl.json"
