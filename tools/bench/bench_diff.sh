#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/bench/archive/bench_diff.sh
# Spec: tools/bench/specs/bench_diff.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/bench/specs/bench_diff.json"
