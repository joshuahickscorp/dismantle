...
Archived body: tools/condense/archive/forge_controller_integration.py
...
_ARCHIVE_PATH = _PathForShim(__shim_file__).parent / "archive" / "forge_controller_integration.py"
