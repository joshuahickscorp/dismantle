...
Archived body: tools/condense/archive/storage_stripdown_controller.py
...
_ARCHIVE_PATH = _PathForShim(__shim_file__).parent / "archive" / "storage_stripdown_controller.py"
