#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/strand/archive/pod-opt.sh
# Spec: tools/strand/specs/pod_opt.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/strand/specs/pod_opt.json"
