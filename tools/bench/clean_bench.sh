#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/bench/archive/clean_bench.sh
# Spec: tools/bench/specs/clean_bench.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/bench/specs/clean_bench.json"
