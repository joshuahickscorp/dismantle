...
fn generation_is_deterministic_across_runs() {
    assert_eq!(hide_sdk::schema::protocol_schema_json(), hide_sdk::schema::protocol_schema_json());
    assert_eq!(hide_sdk::ts::protocol_typescript(), hide_sdk::ts::protocol_typescript());
    assert_eq!(hide_sdk::command::command_catalog_json(), hide_sdk::command::command_catalog_json());
    assert_eq!(hide_sdk::command::command_typescript(), hide_sdk::command::command_typescript());
}
#[test]
