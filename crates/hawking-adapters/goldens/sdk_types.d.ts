...
export const FAMILY_ADAPTERS: FamilyAdapterEntry[] = [
  ...
  },
  {
    ...
    evidence: [
      { path: "research/evidence/glm52/GLM52_FLAGSHIP_ADAPTER_PARITY.json", claim: "M04_SEALED: Rust adapter vs oracle on real flagship .gravity shards", kind: "small_checkpoint_run" },
  ...
  },
  {
    ...
    evidence: [
      { path: "research/evidence/kimi-k26/KIMI_K26_ADAPTER_TWIN.json", claim: "synthetic CPU reference + bound real-source metal K1 twin", kind: "synthetic_parity" },
  ...
  },
  {
    ...
    level: "DECLARED",
    evidence: [
      { path: "research/evidence/fabric/FABRIC_BRIDGE_ARCHAEOLOGY.md", claim: "family listed in bridge archaeology; no serve path found", kind: "description" },
    ],
