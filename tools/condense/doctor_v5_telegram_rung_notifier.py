...
Archived body: tools/condense/archive/doctor_v5_telegram_rung_notifier.py
...
_ARCHIVE_PATH = _PathForShim(__shim_file__).parent / "archive" / "doctor_v5_telegram_rung_notifier.py"
