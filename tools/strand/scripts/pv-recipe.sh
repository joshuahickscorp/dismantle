#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/strand/archive/pv-recipe.sh
# Spec: tools/strand/specs/pv_recipe.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/strand/specs/pv_recipe.json"
