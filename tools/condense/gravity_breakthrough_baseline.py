...
Archived body: tools/condense/archive/gravity_breakthrough_baseline.py
...
_ARCHIVE_PATH = _PathForShim(__shim_file__).parent / "archive" / "gravity_breakthrough_baseline.py"
