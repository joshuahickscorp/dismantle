...
Archived body: tools/condense/archive/kimi_k26_stale_download_cleanup.py
...
_ARCHIVE_PATH = _PathForShim(__shim_file__).parent / "archive" / "kimi_k26_stale_download_cleanup.py"
