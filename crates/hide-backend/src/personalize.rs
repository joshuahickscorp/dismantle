...
//!     [`hide_kernel::security::Redactor`]), the `dataset/vNNN` layout, and the full
...
use crate::personalize::records::{Hash32, Outcome, PersonalizationRecord};
use crate::personalize::store::PersonalLayout;
...
mod tests {
    use super::*;
    use crate::personalize::records::TaskClass;
...
use crate::personalize::records::Hash32;
...
///   * **LLM-proposed semantic evals** (DSPy/ADAS-style, see [`crate::personalize::prompts`])
...
mod tests {
    ...
    async fn miner_auto_adds_untested_load_bearing_function() {
        ...
        index.add_text_file(
            "src/app.rs",
            "use crate::personalize::math::compute;\npub fn run() -> i32 { compute(41) }\n",
            Some("a".into()),
        );
        let miner = EvalMiner::with_defaults();
...
// --- inlined personalize/kv_handoff.rs ---
pub mod kv_handoff {
...
// --- inlined personalize/prompts.rs ---
pub mod prompts {
...
//!
//! Each of those requires the production eval flywheel ([`crate::personalize::eval`]) plus a
...
// --- inlined personalize/records.rs ---
pub mod records {
...
// --- inlined personalize/retrieval.rs ---
pub mod retrieval {
...
//!     run through the real [`hide_kernel::security::Redactor`] (the same detector suite
...
use crate::personalize::records::{PersonalizationRecord, TaskClass};
