...
//! live TokenCommandBuffer; under HAWKING_QWEN_Q4K_LMHEAD=1 the LM-head Q4_K
...
//!
//! Sets HAWKING_QWEN_Q4K_LMHEAD=1 BEFORE load (the full-vocab Q4_K head is
...
//!
//! Run:
//!   cargo test --release -p hawking-core --test multiseq_single_tcb_tail_parity \
