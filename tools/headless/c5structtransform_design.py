...
def confirm_prior_science() -> dict:
    ...
    share = git_show_json("workspace/superwave/g1/claude-evidence/g1_share_basis.json")
    if share and "identity" in share:
        ident = share["identity"]
        rec("G1_SHARE", "workspace/superwave/g1/claude-evidence/g1_share_basis.json", True, {
        ...
        rec("G1_SHARE", "workspace/superwave/g1/claude-evidence/g1_share_basis.json", False, "missed")

    tens = git_show_json("workspace/superwave/g1/claude-evidence/g1_tensor_operators.json")
    if tens and tens.get("tensors"):
        ...
        rec("G1_TENSOR", "workspace/superwave/g1/claude-evidence/g1_tensor_operators.json", True, {
            "tensor0": t0.get("name"),
            "n_operators": len(ops),
            "healthy": healthy,
            "families": fams,
        ...
        rec("G1_TENSOR", "workspace/superwave/g1/claude-evidence/g1_tensor_operators.json", False, "missed")
