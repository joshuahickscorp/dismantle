# DELEGATION — O005 MODEST GRAVITY (q3-g32-experts; gate profile: MLX/Metal)
...
READ tools/odyssey_patient_runner.py, tools/worker_gate.py, tools/doctor_seal.py, workspace/campaign/odyssey/patients/O005/census.json, workspace/campaign/odyssey/patients/O005/ODYSSEY_PATIENT_O005.json, receipts/odyssey-i/O005_EXTERNAL.json
VERIFY receipts/odyssey-i/O005_GRAVITY_q3-g32-experts.json by running the unfenced command below; must pass, exit 0.
python3 tools/odyssey_patient_runner.py --oxx O005 --weights /Users/scammermike/.cache/huggingface/hub/models--Qwen--Qwen3-30B-A3B/snapshots/ad44e777bcd18fa416d9da3bd8f70d33ebb85d39 --runtime mlx --out receipts/odyssey-i/O005_GRAVITY_q3-g32-experts.json --packet workspace/campaign/odyssey/patients/O005/ODYSSEY_PATIENT_O005.json --gravity q3-g32-experts
