#!/usr/bin/env python3
"""lab_harness archive shim — body at tools/strand/archive/scripts/event-sparsity-probe.py."""
...
_TARGET = _repo() / 'tools/strand/archive/scripts/event-sparsity-probe.py'
