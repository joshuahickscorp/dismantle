#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/bench/archive/ab_lever.sh
# Spec: tools/bench/specs/ab_lever.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/bench/specs/ab_lever.json"
