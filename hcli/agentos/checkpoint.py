    ...
    *,
    ...
    return {
        ...
        "next_actions": [
            ...
            "use the bounded native routed-expert, layer-0 shared-expert, and shared-expert-to-hyperconnection candidate graphs as Flash anchors; qualify hc_norm and exact same-model semantics next, and fill actual EBPW/token-ns fields only from native protected complete-token receipts",
        ],
