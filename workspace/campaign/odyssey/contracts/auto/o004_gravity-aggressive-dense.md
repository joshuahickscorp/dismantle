...
AGGRESSIVE: uniform 2-bit group64 (`q2-g64`). candidate_class=AGGRESSIVE_QUANT. Complete bpw (payload+scales+biases+metadata). On fail: localize, do not globally retreat.
