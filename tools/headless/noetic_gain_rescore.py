...
PACKERS = [
    {
        "path": "workspace/superwave/g1/claude-evidence/g1_func_objective.py",
        "fn": "pack_axes",
        "lines": (309, 310),
        "note": "stores only observed/probed/worst_unit; drops gain even if axes() returns it",
    },
    {
        "path": "workspace/superwave/g1/claude-evidence/g1_adversarial_frontier.py",
        "fn": "score_pack",
        "lines": (360, 372),
...
def try_load_l0_gate() -> tuple[np.ndarray | None, dict]:
    ...
    pin = resolve("workspace/superwave/g1/GRAVITY1_SOURCE_PIN.json")
    if pin:
        try:
...
CAMPAIGN_SPEC = [
    {
        ...
        "receipts": ["workspace/superwave/g1/claude-evidence/g1_adversarial_frontier.json"],
    ...
    },
    {
        ...
        "receipts": ["workspace/superwave/g1/claude-evidence/g003-L0.json"],
    ...
    },
    {
        ...
        "receipts": ["workspace/superwave/g1/claude-evidence/g003-L31.json"],
    ...
    },
    {
        ...
        "receipts": ["workspace/superwave/g1/claude-evidence/g003-gate.json"],
        "ranking_metric": "observed/probed/worst_unit",
        "notes": "",
    },
    {
        ...
        "receipts": ["workspace/superwave/g1/claude-evidence/g1_tensor_operators.json"],
    ...
    },
    {
        ...
        "receipts": [
            "workspace/superwave/g1/claude-evidence/g1_share_basis.json",
            "workspace/superwave/g1/claude-evidence/g1_share_basis_smoke.json",
        ],
    ...
    },
    {
        ...
        "receipts": ["workspace/superwave/g1/claude-evidence/g1_xform_hadamard.json"],
    ...
    },
    {
        ...
        "receipts": [
            "workspace/superwave/g1/claude-evidence/g1_planes_ternary.json",
            "workspace/superwave/g1/claude-evidence/g1_planes_ternary_smoke.json",
            "workspace/superwave/g1/claude-evidence/g1_planes_lm_head.json",
        ],
    ...
    },
    {
        ...
        "receipts": [
            "workspace/superwave/g1/claude-evidence/g1_alloc_unified_out.json",
            "workspace/superwave/g1/claude-evidence/g1_alloc_unified_measure.json",
        ],
    ...
    },
    {
        ...
        "receipts": [
            "workspace/superwave/g1/claude-evidence/g005-alloc.json",
            "workspace/superwave/g1/claude-evidence/g005-curves.json",
        ],
    ...
    },
    {
        ...
        "receipts": ["workspace/superwave/g1/claude-evidence/g1_reshape_before_lowbit.json"],
    ...
    },
    {
        ...
        "receipts": ["workspace/superwave/g1/claude-evidence/g010.json"],
    ...
    },
    {
        ...
        "receipts": [
            "workspace/superwave/g1/claude-evidence/g1_capability_gate_full_cosine.json",
            "workspace/superwave/g1/claude-evidence/g1_capability_gate_measure.json",
        ],
    ...
    },
    {
        ...
        "receipts": ["workspace/superwave/g1/claude-evidence/endpoint.json"],
...
def archive_rescore() -> tuple[list[dict], list[dict], dict]:
    ...
    data, where = load_json("workspace/superwave/g1/claude-evidence/g1_adversarial_frontier.json")
    ...
    meas, mwhere = load_json("workspace/superwave/g1/claude-evidence/g1_capability_gate_measure.json")
    ...
    alloc, aw = load_json("workspace/superwave/g1/claude-evidence/g1_alloc_unified_out.json")
