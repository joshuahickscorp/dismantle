#!/usr/bin/env python3
"""lab_harness archive shim — body at tools/strand/archive/scripts/selfdesc-interpreter.py."""
...
_TARGET = _repo() / 'tools/strand/archive/scripts/selfdesc-interpreter.py'
