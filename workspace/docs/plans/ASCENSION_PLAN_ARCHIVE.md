# Superseded Ascension plan index

These planning drafts formed a closed, unreferenced historical subfamily. The
implementation, current contracts, and sealed decisions live elsewhere; Git
retains the original prose. This index preserves the planning topics and
prevents an old draft from presenting itself as a second authority.

Retired drafts:

- `ASCENSION_80B_HYBRID_ARCHITECTURE_PLAN.md`
- `ASCENSION_HCLI_PRODUCT_TEST_PLAN.md`
- `ASCENSION_NOTIFICATIONS_PLAN.md`
- `ASCENSION_PRESSURE_GOVERNOR_PLAN.md`
- `ASCENSION_TG_GAUNTLET_HARNESS_PLAN.md`
- `HCLI_COMMUNICATION_BUS_PLAN.md`
- `HCLI_OPTION_C_PLAN.md`
- `HCLI_PLANNING_DIAGNOSTIC_PLAN.md`
- `HCLI_RESIDENCY_MODES_PLAN.md`
- `HCLI_RETRIEVAL_GATEWAY_PLAN.md`
- `HCLI_TOOL_GATEWAY_PLAN.md`
- `SANDBOX_READY_PREFLIGHT.md`
