...
Archived body: tools/condense/archive/_bench_fetch_workers_nodisk.py
...
_ARCHIVE_PATH = _PathForShim(__shim_file__).parent / "archive" / "_bench_fetch_workers_nodisk.py"
