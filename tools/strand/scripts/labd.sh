#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/strand/archive/labd.sh
# Spec: tools/strand/specs/labd.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/strand/specs/labd.json"
