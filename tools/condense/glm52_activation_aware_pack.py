...
Archived body: tools/condense/archive/glm52_activation_aware_pack.py
...
_ARCHIVE_PATH = _PathForShim(__shim_file__).parent / "archive" / "glm52_activation_aware_pack.py"
