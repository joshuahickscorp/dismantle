...
Archived body: tools/condense/archive/gravity_profiler_acceptance.py
...
_ARCHIVE_PATH = _PathForShim(__shim_file__).parent / "archive" / "gravity_profiler_acceptance.py"
