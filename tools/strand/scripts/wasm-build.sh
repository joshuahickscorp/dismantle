#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/strand/archive/wasm-build.sh
# Spec: tools/strand/specs/wasm_build.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/strand/specs/wasm_build.json"
