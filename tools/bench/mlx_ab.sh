#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/bench/archive/mlx_ab.sh
# Spec: tools/bench/specs/mlx_ab.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/bench/specs/mlx_ab.json"
