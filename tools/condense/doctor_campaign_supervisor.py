...
Archived body: tools/condense/archive/doctor_campaign_supervisor.py
...
_ARCHIVE_PATH = _PathForShim(__shim_file__).parent / "archive" / "doctor_campaign_supervisor.py"
