...
| current `225bc6346` | 1,399,930 | 3,025 | 712,032 | 490,165 | 1,095 | 40.600% |
...
The current row is the clean-tree measurement at commit `225bc6346ae6e4c1f16b1b4f98fb6dab062c5395`.
It includes the small ABI, contract, and receipt-path corrections made after
the historical compaction checkpoint. The code-only Rust share is computed as
...
Against the Phase III base, the current tree is down 427,410 active physical
...
|---|---|---|
| at least 10,000 active source LOC removed | base 1,827,340 -> current 1,399,930 | met |
