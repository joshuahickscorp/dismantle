...
use crate::extension_registry::manifest::{CapabilityKind, CapabilityManifest, Effect, FullSchema, Scope, SchemaRef};
...
impl Registry {
    ...
    pub fn provenance(&self, id: &str) -> Result<crate::extension_registry::manifest::Provenance> {
