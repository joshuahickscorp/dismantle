#!/usr/bin/env python3
"""lab_harness archive shim — body at tools/training/archive/rwkv7_competitive_scorecard.py."""
...
_TARGET = _repo() / 'tools/training/archive/rwkv7_competitive_scorecard.py'
