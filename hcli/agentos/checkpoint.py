    ...
    *,
    ...
    return {
        ...
        "next_actions": [
            ...
            "use the bounded native gate/up-to-down composition as the next Flash graph anchor; fill actual EBPW/token-ns fields only from native protected complete-token receipts",
        ],
