# DELEGATION — O006 AGGRESSIVE GRAVITY (q2-g32-experts; gate profile: MLX/Metal)
...
Write receipts/odyssey-i/O006_GRAVITY_q2-g32-experts.json (schema odyssey.patient.gravity.v1): spec, stored/active bpw, complete_bpw,
...
## ACCEPTANCE
- receipts/odyssey-i/O006_GRAVITY_q2-g32-experts.json exists with stored_bpw < 16, complete_bpw, nominal_bits, candidate_class,
