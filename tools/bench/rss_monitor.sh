#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/bench/archive/rss_monitor.sh
# Spec: tools/bench/specs/rss_monitor.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/bench/specs/rss_monitor.json"
