...
Archived body: tools/condense/archive/glm52_route_population_census.py
...
_ARCHIVE_PATH = _PathForShim(__shim_file__).parent / "archive" / "glm52_route_population_census.py"
