...
Archived body: tools/condense/archive/gravity_frontier_g4_controller.py
...
_ARCHIVE_PATH = _PathForShim(__shim_file__).parent / "archive" / "gravity_frontier_g4_controller.py"
