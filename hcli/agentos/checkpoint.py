    ...
    *,
    ...
    return {
        ...
        "next_actions": [
            ...
            "advance the source-backed Flash Noetic routed-expert graph toward a source-independent candidate body; fill actual EBPW/token-ns fields only from native protected receipts",
        ],
