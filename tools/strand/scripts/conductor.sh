#!/usr/bin/env bash
# Thin laboratory-harness front-end. Body: tools/strand/archive/conductor.sh
# Spec: tools/strand/specs/conductor.json
set -euo pipefail
...
exec python3.12 -m lab_harness run "$ROOT/tools/strand/specs/conductor.json"
